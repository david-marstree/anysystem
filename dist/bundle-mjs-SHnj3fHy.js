...
function ie(e) {
  ...
  return ae(Object.entries(e.classGroups), t).forEach(([n, s]) => {
    _(s, o, n, r);
  }), o;
}
function _(e, r, t, o) {
...
function de(e) {
  ...
  return function(s) {
    ...
    const g = a.length === 0 ? s : s.substring(b), h = g.startsWith(ee), w = h ? g.substring(1) : g, S = p && p > b ? p - b : void 0;
    return {
      modifiers: a,
...
function fe(e, r) {
  ...
  return e.trim().split(be).map((s) => {
    ...
    let g = o(p ? b.substring(0, p) : b), h = !!p;
    if (!g) {
      if (!p)
        return {
          isTailwindClass: !1,
    ...
    return n.has(p) ? !1 : (n.add(p), l(u, b).forEach((g) => n.add(a + g)), !0);
